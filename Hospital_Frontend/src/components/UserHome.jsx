...
const UserHome = () => {
  ...
  const settings = {
    accessibility: true, dots: true, infinite: true, speed: 500, arrows: false, slidesToShow: 3, slidesToScroll: 1,
    responsive: [
    ...
    <div className="min-h-screen">
      <nav className="bg-backgroundColor text-white py-4 px-5 lg:px-32 shadow-lg flex justify-between items-center">
        ...
        <div className="flex space-x-6">
          <Link to="/user/userhome" className="hover:text-gray-300">Home</Link>
      ...
      <div className="flex flex-col justify-center lg:px-32 px-5 pt-16">
        <div className="flex flex-col items-center lg:flex-row justify-between mb-10 lg:mb-0">
          <div>
            ...
            <p className="mt-2 text-center lg:text-start">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Natus, quidem.</p>
          </div>
        ...
        <Slider ref={slider} {...settings}>
          {data.map((e, index) => (
            <div className="h-[350px] text-black rounded-xl shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] mb-2 cursor-pointer w-full" key={index}>
